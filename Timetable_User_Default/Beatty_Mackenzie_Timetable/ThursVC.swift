...
class ThursVC: UIViewController, UITableViewDelegate, UITableViewDataSource, darkModeStatus,TableUpdate {
    ...
    override func viewDidLoad() {
        ...
        if let tempData = UserDefaults.standard.value(forKey: "Thursday") as? [[String : String]]{
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete{
            ...
            UserDefaults.standard.set(ArrayOfData, forKey: "Thursday")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        else if segue.identifier == "Create_Segue_Thursday"{
