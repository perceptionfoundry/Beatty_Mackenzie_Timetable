...
class TuesVC: UIViewController, UITableViewDelegate, UITableViewDataSource, darkModeStatus,TableUpdate{
...
//        print(value)
    ...
    override func viewDidLoad() {
        ...
        if let tempData = UserDefaults.standard.value(forKey: "Tuesday") as? [[String : String]]{
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete{
            ...
            UserDefaults.standard.set(ArrayOfData, forKey: "Tuesday")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        else if segue.identifier == "Create_Segue"{
            
            let dest = segue.destination as! CreateTackVC
            dest.delegate = self
            
        }
        else if segue.identifier == "Create_Segue_Tuesday"{
