...
class FriVC: UIViewController, UITableViewDelegate, UITableViewDataSource, darkModeStatus,TableUpdate{
...
//        print(value)
    ...
    override func viewDidLoad() {
        ...
        if let tempData = UserDefaults.standard.value(forKey: "Friday") as? [[String : String]]{
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete{
            ...
            UserDefaults.standard.set(ArrayOfData, forKey: "Friday")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        else if segue.identifier == "Create_Segue_Friday"{
