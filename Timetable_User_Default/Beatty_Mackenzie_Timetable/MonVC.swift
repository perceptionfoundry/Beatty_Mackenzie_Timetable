...
class MonVC: UIViewController, UITableViewDelegate, UITableViewDataSource, darkModeStatus, TableUpdate{
...
//        print(value)
    ...
    override func viewDidLoad() {
        ...
        if let tempData = UserDefaults.standard.value(forKey: "Monday") as? [[String : String]]{
...
//      print(TodayTask)
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete{
            ...
            UserDefaults.standard.set(ArrayOfData, forKey: "Monday")
...
//            print(sendData)
        ...
        else if segue.identifier == "Create_Segue_Monday"{
